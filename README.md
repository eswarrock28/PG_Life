...
9. Through the entire web app, each and every execution is handled well using custom codes and UI,	such that they are easily managed, and user can get to know the fault.
